...
if ($start && $end && !$confirmdelete) {   // Show a full transcript.
    ...
    if ($deletesession && has_capability('mod/chat:deletelog', $context)) {
...
if ($deletesession && has_capability('mod/chat:deletelog', $context)
    && $confirmdelete && $start && $end && confirm_sesskey()) {
